...
+ (void)registerForNetworkReachabilityNotifications
{
	[[ReachabilityWifi reachabilityForInternetConnection] startNotifier];
...
{
	return ([[ReachabilityWifi reachabilityForInternetConnection] currentReachabilityStatus] == ReachableViaWWAN);	
}
